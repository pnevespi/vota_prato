...
class QualificacoesControllerTest < ActionController::TestCase
  ...
  test "should create qualificacao" do
    assert_difference('Qualificacao.count') do
      post :create, qualificacao: { cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id=integer: @qualificacao.restaurante_id=integer, valor_gasto: @qualificacao.valor_gasto }
    end
  ...
  test "should update qualificacao" do
    put :update, id: @qualificacao, qualificacao: { cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id=integer: @qualificacao.restaurante_id=integer, valor_gasto: @qualificacao.valor_gasto }
    assert_redirected_to qualificacao_path(assigns(:qualificacao))
  end
